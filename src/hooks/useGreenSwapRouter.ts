// copy from https://github.com/Uniswap/uniswap-v2-sdk/blob/main/src/router.ts
  ...
  public static swapCallParameters(
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          // methodName = useFeeOnTransfer ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForUSDC'
          // uniswap: (uint amountOutMin, address[] calldata path, address to, uint deadline)
          ...
          // uniswap: (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapExactETHForUSDC'
          // uniswap: (uint amountOut, address[] calldata path, address to, uint deadline)
          // args = [amountOut, path, to, deadline]
          // -------------------------------------------------------------
          // greenswap:
          // function swapExactETHForUSDC(uint256 amountOutMin, uint256 deadline)
